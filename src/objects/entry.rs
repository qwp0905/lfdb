...
use super::{
  RecordData, RecordDataView, SerializeType, TaggedObject, VersionRecord,
  VersionRecordView, SERIALIZABLE_BYTES,
};
use crate::{
...
impl DataEntry {
  pub const fn empty(next: Option<Pointer>) -> Self {
    Self {
      next,
...
impl TaggedObject for DataEntry {
...
impl TaggedObject for DataEntryView {
